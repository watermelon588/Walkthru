...
| 25 | **Paid features promised but not built** | Copy review, funnel numbers and competitor side by side are in SPEC's plan table and not in the code; PageSpeed key unset; SPEC claims TLS checks that do not exist | Build them or remove them before any charge | Phase 0 |
